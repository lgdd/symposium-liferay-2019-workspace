...
<%
	...
	PartPermissionChecker partPermissionChecker =
			(PartPermissionChecker) renderRequest.getAttribute("partPermissionChecker");

	boolean hasAddPermission = partPermissionChecker.containsTopLevel(
			permissionChecker, scopeGroupId, "ADD_PART");
	boolean hasConfigurePermission = partPermissionChecker.containsTopLevel(
